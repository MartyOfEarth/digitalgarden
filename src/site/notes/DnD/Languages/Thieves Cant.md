...
**Summary:** Thieves cant is not a [[DnD/Languages/Languages\|language]] in-and-of-itself, but can be spoken in any [[DnD/Languages/Languages\|language]]. It is a way of communicating hidden messages in seemingly innocent words, gestures, actions, etc.. The more familiar the speakers are with one another, the more intricate and elaborate the [[DnD/Languages/Languages\|language]] becomes between them. Everything about the [[DnD/Languages/Languages\|language]] is situational, making it extremely difficult to decode.
