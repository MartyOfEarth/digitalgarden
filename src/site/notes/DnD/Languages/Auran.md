...
**Summary:** Auran is a unique [[DnD/Languages/index\|language]], in that it doesn't require vocal cords to speak, only a set of lungs (or other air-moving apparatus). 
